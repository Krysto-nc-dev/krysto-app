              ...
              >
                <Popover.Panel className="absolute right-0 z-10 mt-2.5 w-48">
                  <div className="bg-primaryColor rounded-sm shadow-md ring-1 ring-black ring-opacity-5 text-sm">
                    ...
                    <Link to="/admin-settings" className="px-4 py-2 text-gray-700 hover:bg-gray-100 flex items-center hover:no-underline"><Settings className="mr-2"/> Paramètres</Link>
                    ...
                    <Link to="/admin-support" className="px-4 py-2 text-gray-700 hover:bg-gray-100 flex items-center hover:no-underline"><MessageCircleQuestion className="mr-2"/> Aide & supports</Link>
