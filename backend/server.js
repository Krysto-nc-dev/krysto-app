...
import campagneCollectRoutes from './routes/campagneCollectRouter.js'
...
import wasteTypeRoutes from './routes/wasteTypeRoutes.js'
...
app.use('/api/v1/veilles', veilleRoutes)
app.use('/api/v1/wastes', wasteTypeRoutes)
